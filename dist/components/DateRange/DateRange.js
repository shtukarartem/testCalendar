  ...
  return _react.default.createElement(
    ...
    _react.default.createElement(RangePicker, {
      ...
      className: (0, _classnames.default)(
        _stylesModule.default.root,
        typeOfViewStyles['standard'],
        sizeStyles['s'],
        ((_classNames = {}),
        _defineProperty(_classNames, _stylesModule.default.fullWidth, isFullWidth),
        _defineProperty(_classNames, _stylesModule.default.error, isError),
        _classNames)
      ),
