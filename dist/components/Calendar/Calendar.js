...
var handleAppointmentAdding = function handleAppointmentAdding(e) {
  var isBusyDate = (0, _utils.checkBusyRoom)(
    _sefviceFormData.data,
...
var openCreationModal = function openCreationModal(e) {
  var _e$event;
...
var openEditingModal = function openEditingModal() {
    ...
    function () {
      if (currentView.type === 'timelineDay' && currentView.intervalCount === 1) {
        setSelectedPlaceholder(
          (0, _dayjs.default)(currentDate).locale('ru').format('DD MMMM YYYY')
        );
      } else
        setSelectedPlaceholder(
          (0, _utils.handleFirstCharInUpperCase)(
            (0, _dayjs.default)(currentDate).locale('ru').format('MMMM YYYY')
          )
        );
    },
    [currentDate, currentView]
    ...
    _react.default.createElement(_Header.Header, {
      ...
      handleAddDate: function handleAddDate() {
        ...
        return setCurrentDate(
          (_handleAddDate = (0, _utils.handleAddDate)(currentView.type, currentDate)) !== null &&
            _handleAddDate !== void 0
            ? _handleAddDate
            : currentDate
        );
      },
      handleSubtractDate: function handleSubtractDate() {
        ...
        return setCurrentDate(
          (_handleSubtractDate = (0, _utils.handleSubtractDate)(currentView.type, currentDate)) !==
            null && _handleSubtractDate !== void 0
            ? _handleSubtractDate
            : currentDate
        );
      },
      handleViewsChange: function handleViewsChange(value) {
        ...
        return setCurrentView(
          (_handldleCheckView = (0, _utils.handldleCheckView)(value)) !== null &&
            _handldleCheckView !== void 0
            ? _handldleCheckView
            : currentView
        );
      },
      handleSelect: function handleSelect(icon) {
        ...
        setCurrentDate(
          (_data$currentData = data === null || data === void 0 ? void 0 : data.currentData) !==
            null && _data$currentData !== void 0
            ? _data$currentData
            : currentDate
        );
        setCurrentView(
          (_data$currentView = data === null || data === void 0 ? void 0 : data.currentView) !==
            null && _data$currentView !== void 0
            ? _data$currentView
            : currentView
        );
      },
