...
var Calendar = function Calendar() {
  ...
  (0, _react.useEffect)(
    function () {
      ...
      setCurrentView(
        (_handldleCheckView = (0, _utils.handldleCheckView)(selectedView)) !== null &&
    ...
    _react.default.createElement(_Header.Header, {
      ...
      handleAddDate: function handleAddDate() {
        ...
        return setCurrentDate(
          (_handleAddDate = (0, _utils.handleAddDate)(selectedView, currentDate)) !== null &&
      ...
      handleSubtractDate: function handleSubtractDate() {
        ...
        return setCurrentDate(
          (_handleSubtractDate = (0, _utils.handleSubtractDate)(selectedView, currentDate)) !==
