...
export declare const handleAddDate: (currentView: string, currentDate: dayjs.Dayjs) => dayjs.Dayjs | undefined;
export declare const handleSubtractDate: (currentView: string, currentDate: dayjs.Dayjs) => dayjs.Dayjs | undefined;
...
export declare const checkBusyRoom: (bookings: BookingType[], rooms: number, startDate: Date, endDate: Date) => boolean;
